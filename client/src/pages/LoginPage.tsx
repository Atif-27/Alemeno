...
import { loginInitialField } from "../constants/initialStates";
import AuthInput from "../components/AuthInput";

function LoginPage() {
  const [fields, setFields] = useState(loginInitialField);
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    dispatch(loginUser({ email: fields.email, password: fields.password })); // Dispatch the action to login the user
  }
  return (
